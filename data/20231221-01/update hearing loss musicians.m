{{"DB" -> "Google Scholar", 
  "TI" -> "Genetic architecture distinguishes tinnitus from hearing loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.nature.com/articles/s41467-024-44842-x", 
  "AB" -> "Tinnitus is a heritable, highly prevalent auditory disorder \
...
14 November 2024"}, {"DB" -> "Google Scholar", "TI" -> "From hidden hearing \
loss to supranormal auditory processing by neurotrophin 3-mediated modulation \
of inner hair cell synapse density", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", "AID" -> "https://journals.plos.org/plosbiology/art\
icle?id=10.1371/journal.pbio.3002665", "AB" -> "Loss of synapses between \
spiral ganglion neurons and inner hair cells (IHC synaptopathy) leads to an \
auditory neuropathy called hidden hearing loss (HHL) characterized by normal \
auditory thresholds but reduced amplitude of sound-evoked auditory \
potentials. It has been proposed that synaptopathy and HHL result in poor \
performance in challenging hearing tasks despite a normal audiogram. However, \
this has only been tested in animals after exposure to noise or ototoxic \
drugs, which can cause deficits beyond synaptopathy. Furthermore, the impact \
of supernumerary synapses on auditory processing has not been evaluated. \
Here, we studied mice in which IHC synapse counts were increased or decreased \
by altering neurotrophin 3 (Ntf3) expression in IHC supporting cells. As we \
previously showed, postnatal Ntf3 knockdown or overexpression reduces or \
increases, respectively, IHC synapse density and suprathreshold amplitude of \
sound-evoked auditory potentials without changing cochlear thresholds. We now \
show that IHC synapse density does not influence the magnitude of the \
acoustic startle reflex or its prepulse inhibition. In contrast, gap-prepulse \
inhibition, a behavioral test for auditory temporal processing, is reduced or \
enhanced according to Ntf3 expression levels. These results indicate that IHC \
synaptopathy causes temporal processing deficits predicted in HHL. \
Furthermore, the improvement in temporal acuity achieved by increasing Ntf3 \
expression and synapse density suggests a therapeutic strategy for improving \
hearing in noise for individuals with synaptopathy of various etiologies.     \
         Citation: Ji L, Borges BC, Martel DT, Wu C, Liberman MC, Shore SE, \
et al. (2024) From hidden hearing loss to supranormal auditory processing by \
neurotrophin 3-mediated modulation of inner hair cell synapse density. PLoS \
Biol 22(6): e3002665. https://doi.org/10.1371/journal.pbio.3002665     \
Academic Editor: Jennifer K. Bizley, University College London, UNITED \
KINGDOM     Received: April 21, 2023; Accepted: May 7, 2024; Published: June \
27, 2024     Copyright: \[Copyright] 2024 Ji et al. This is an open access \
article distributed under the terms of the Creative Commons Attribution \
License , which permits unrestricted use, distribution, and reproduction in \
any medium, provided the original author and source are credited.     Data \
Availability: All data files are available from the Dryad database (accession \
number https://doi.org/10.5061/dryad.k6djh9w8v ).     Funding: This work was \
...
scientific founders of Auricle, Inc and have equity"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> 
   "Planning to accommodate war-induced tinnitus and hearing loss in Ukraine"\
, "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.nature.com/articles/s44284-023-00029-x", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Early loss of spiral ganglion neurons in the auditory system after \
noise trauma", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://karger.com/aud/article-pdf/doi/10.1159/000539359/4229198/\
000539359.pdf", "AB" -> "no abstract available"}, 
 {"DB" -> "Google Scholar", "TI" -> "The effects of music listening time with \
headphones on hearing thresholds among the young population", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/article/10.1186/s43163-024-00574-9", 
  "AB" -> "Background     Today, young people who listen to loud music, \
...
risk for th"}, {"DB" -> "Google Scholar", "TI" -> "Sound elicits stereotyped \
facial movements that provide a sensitive index of hearing abilities in mice"\
, "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.cell.com/current-biology/abstract/S0960-9822(24)00239-2", 
  "AB" -> "Article title, abstract, keywords     Search within: This journal \
Full site Advanced search          Please enter a term before submitting your \
search. Ok                                                      Article \
Volume 34 , Issue 8 p1605-1620.e5 April 22, 2024 Sound elicits stereotyped \
facial movements that provide a sensitive index of hearing abilities in mice  \
   Kameron K. Clayton 1 , 2 , 4 [email\[NonBreakingSpace]protected] \:2219 \
Kamryn S. Stecyk 1 \:2219 Anna A. Guo 1 \:2219 \[Ellipsis] \:2219 Anna R. \
Chambers 1 , 2 \:2219 Ke Chen 1 , 2 , 3 \:2219 Kenneth E. Hancock 1 , 2 \
\:2219 Daniel B. Polley 1 , 2 \[Ellipsis] Show more Show less          1 \
Eaton-Peabody Laboratories, Massachusetts Eye and Ear, Boston, MA 02114, USA  \
   2 Department of Otolaryngology\[Dash]Head and Neck Surgery, Harvard \
Medical School, Boston, MA 02114, USA          3          Present address: \
McGovern Institute for Brain Research, MIT, Cambridge, MA 02139, USA          \
4          Lead contact          Publication History:     Received September \
7, 2023 ; Revised January 2, 2024 ; Accepted February 23, 2024 ; Published \
online March 15, 2024     DOI: 10.1016/j.cub.2024.02.057 Also available on \
ScienceDirect     Copyright: \[Copyright] 2024 Elsevier Inc.                  \
   Download Full Issue          Download started Ok                           \
   Get Access   Outline     Highlights Summary Graphical abstract"}, 
 {"DB" -> "Google Scholar", "TI" -> "Norepinephrine protects against cochlear \
outer hair cell damage and noise-induced hearing loss via \
&#945;<sub>2A</sub>-adrenergic receptor", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/article/10.1186/s12868-024-00845-4", 
  "AB" -> "Background     The cochlear sympathetic system plays a key role in \
auditory function and susceptibility to noise-induced hearing loss (NIHL). \
The formation of reactive oxygen species (ROS) is a well-documented process \
in NIHL. In this study, we aimed at investigating the effects of a superior \
cervical ganglionectomy (SCGx) on NIHL in Sprague-Dawley rats. Methods     We \
explored the effects of unilateral and bilateral Superior Cervical Ganglion \
(SCG) ablation in the eight-ten weeks old Sprague-Dawley rats of both sexes \
on NIHL. Auditory function was evaluated by auditory brainstem response (ABR) \
testing and Distortion product otoacoustic emissions (DPOAEs). Outer hair \
cells (OHCs) counts and the expression of \[Alpha] 2A -adrenergic receptor \
(AR) in the rat cochlea using immunofluorescence analysis. Cells culture and \
treatment, CCK-8 assay, Flow cytometry staining and analysis, and western \
blotting were to explore the mechanisms of SCG fibers may have a protective \
role in NIHL. Results     We found that neither bilateral nor unilateral SCGx \
protected the cochlea against noise exposure. In HEI-OC1 cells, H 2 O 2 \
-induced oxidative damage and cell death were inhibited by the application of \
norepinephrine (NE). NE may prevent ROS-induced oxidative stress in OHCs and \
NIHL through the \[Alpha] 2A -AR. Conclusion     These results demonstrated \
that sympathetic innervation mildly affected cochlear susceptibility to \
acoustic trauma by reducing oxidative damage in OHCs through the \[Alpha] 2A \
-AR. NE may be a potential therapeutic strategy for NIHL prevention.          \
      View this article's peer review reports                Similar content \
being viewed by others                                Effects of Noise Damage \
on the Purinergic Signal of Cochlear Spiral Ganglion Cells in Guinea Pigs     \
       Article   05 May 2023                                  Otoprotective \
Effects of Stephania tetrandra S. Moore Herb Isolate against Acoustic Trauma  \
          Article   05 September 2018                                  \
Protective and therapeutic effects of milrinone on acoustic trauma in rat \
cochlea            Article   06 April 2019                           \
Background          Noise-induced hearing loss (NIHL) occurs when the \
sensitive structures in the inner ear are damaged by loud sound. Exposure to \
workplace noise for 10 years or more increased the odds of having any kind of \
hearing loss by a ratio of 2.4 and an increased risk ratio of 6.8 for \
moderate-to-severe hearing loss [ 1 ]. Approximately \
22\[NonBreakingSpace]million workers in the United States (US) are exposed to \
hazardous noise at work [ 2 ]. In China, it\[CloseCurlyQuote]s estimated that \
approximately 80\[NonBreakingSpace]million workers exposed to hazardous noise \
[ 3 ].     Following superior cervical ganglionectomy (SCGx) the \
norepinephrine (NE) tissue levels were decreased after several hours [ 4 ]. \
The sympathetic nervous system (SNS) demonstrated a protective effect against \
noise-induced damage [ 5 , 6 , 7 ]. Presynaptic activation of \[Alpha] 2 \
-adrenergic rec"}, {"DB" -> "Google Scholar", 
  "TI" -> "Noise-induced Hearing Loss: Continuous versus Impact/impulse \
Noise", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.lww.com/ijom/fulltext/2024/01310/noise_induced_h\
earing_loss__continuous_versus.2.aspx?context=latestarticles", 
  "AB" -> "Background:       Impact/impulse and continuous noise are two main \
causes of noise-induced hearing loss (NIHL) in workplaces. The aim of this \
study was to compare the effects of impulse/impact noise and continuous noise \
on hearing status.   Methods:       In this study, 259 workers referred to \
the occupational medicine clinic of Shahid Rahnemoun hospital, Yazd, Iran, \
...
fast increase and decrease"}, {"DB" -> "Google Scholar", 
  "TI" -> "Advances in Evaluation of Electrode Insertion Trauma Induced \
Residual Hearing loss in Cochlear Implant Recipients and its significance-A \
Narrative Review", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", 
  "PT" -> "", "AID" -> 
   "https://link.springer.com/article/10.1007/s12070-024-04801-w", 
  "AB" -> "Cochlear implant surgery has revolutionized the management of \
profound hearing loss, with a growing focus on preserving residual hearing, \
particularly low-frequency hearing. This review synthesizes existing \
literature on cochlear implantation techniques, surgical principles, and \
emerging therapies aimed at reducing post-implantation hearing loss. \
Methodologically, a comprehensive narrative literature review was conducted, \
encompassing various study designs and participant demographics. The search \
strategy involved major biomedical databases, focusing on articles in \
English. Surgical techniques such as \[OpenCurlyDoubleQuote]soft \
surgery\[CloseCurlyDoubleQuote] emphasize minimizing mechanical stress on the \
cochlea, while advancements in pharmacological agents explore the use of \
corticosteroids, neurotrophins, and growth factors to enhance hearing \
preservation. Electrode design and insertion strategies are evolving to \
minimize trauma and optimize hearing outcomes, including consideration of \
insertion forces and electrode array designs. Evaluating residual hearing \
loss involves sophisticated techniques like electrocochleography and \
radiological imaging. The impact of residual hearing on auditory verbal \
outcomes is variable, with studies indicating positive correlations with \
language development, particularly in speech production. Emerging strategies \
in electrode design, surgical techniques, and drug delivery hold promise for \
improving outcomes in cochlear implantation. However, challenges such as the \
lack of standardized guidelines and the need for further clinical trials \
remain. Future directions include the exploration of nanotechnologies, gene \
therapies, and stem cells for constructing bionic ears, although ethical and \
technical hurdles persist. This review underscores the ongoing efforts to \
enhance cochlear implant functionality and the need for continued research to \
optimize outcomes for patients with hearing loss.                     Similar \
content being viewed by others                                Loss of \
Residual Hearing Initiated by Cochlear Implantation: Role of \
Inflammation-Initiated Cell Death Pathways, Wound Healing and Fibrosis \
...
prominence, especially for those with residual low-frequency hearing. Ele"}, 
 {"DB" -> "Google Scholar", "TI" -> "Investigation of the effectiveness of \
sound enrichment in the treatment of tinnitus due to hearing loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://onlinelibrary.wiley.com/doi/abs/10.1002/brb3.3520", 
  "AB" -> "Objective       In previous animal studies, sound enhancement \
...
55\[NonBreakingSpace]dB HL in a relatively short period of 1 month.           \
          1"}, {"DB" -> "Google Scholar", "TI" -> "Investigation of the \
effectiveness of sound enrichment in the treatment of tinnitus due to hearing \
loss", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://onlinelibrary.wiley.com/doi/abs/10.1002/brb3.3520", 
  "AB" -> "Objective       In previous animal studies, sound enhancement \
reduced tinnitus perception in cases associated with hearing loss. The aim of \
...
positive and the tinnitus pitch is matched with a hearing loss between 45 and \
55\[NonBreakingSpace]dB HL in a relatively short period of 1 month.           \
          1"}, {"DB" -> "Google Scholar", "TI" -> "Neurodegeneration after \
repeated noise trauma in the mouse lower auditory pathway", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S030439402300530X", 
  "AB" -> "High intensity noise exposure leads to a permanent shift in \
auditory thresholds (PTS), affecting both peripheral (cochlear) tissue and \
the central auditory system. Studies have shown that a noise-induced hearing \
loss results in significant cell loss in several auditory structures. \
Degeneration can be demonstrated within hours after noise exposure, \
particularly in the lower auditory pathway, and continues to progress over \
days and weeks following the trauma. However, there is limited knowledge \
about the effects of recurring acoustic trauma. Repeated noise exposure has \
been demonstrated to increase neuroplasticity and neural activity. Thus, the \
present study aimed to investigate the influence of a second noise exposure \
on the cytoarchitecture of key structures of the auditory pathway, including \
spiral ganglion neurons (SGN), the ventral and dorsal cochlear nucleus (VCN \
and DCN, respectively), and the inferior colliculus (IC). In the experiments, \
young adult normal hearing mice were exposed to noise once or twice (with the \
second trauma applied one week after the initial exposure) for \
3\[NonBreakingSpace]h, using broadband white noise (5 \[Dash] \
20\[NonBreakingSpace]kHz) at 115\[NonBreakingSpace]dB SPL. The cell densities \
in the investigated auditory structures significantly decreased in response \
to the initial noise exposure compared to unexposed control animals. These \
findings are consistent with earlier research, which demonstrated \
degeneration in the auditory pathway within the first week after acoustic \
trauma. Additionally, cell densities were significantly decreased after the \
second trauma, but this effect was only observed in the VCN, with no similar \
effects seen in the SGN, DCN, or IC. These results illustrate how repeated \
noise exposure influences the cytoarchitecture of the auditory system. It \
appears that an initial noise exposure primarily damages the lower auditory \
pathway, but surviving cellular structures may develop resistance to \
additional noise-induced injury.     Previous article in issue Next article \
in issue"}, {"DB" -> "Google Scholar", 
  "TI" -> "Risk of noise-induced hearing loss in the spine surgeon", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S2666548423000999", 
  "AB" -> "Background     Occupation-related noise-induced hearing loss \
(NIHL) has both negative economic and quality of life implications. The risk \
spine surgeons undertake in regards to NIHL during operative intervention is \
unknown. Governing bodies, including the National Institute for Occupational \
Safety and Health, have recommended exposure limits not to exceed 85 decibels \
(dB) over 8 hours. The purpose of this study is to characterize noise \
exposure to spine surgeons in the operating room (OR).     Methods     \
Prospective collection of intraoperative recordings of spinal surgeries \
(cervical and thoracic/lumbar) was undertaken. Data gathered included \
procedure, operative duration, presence of background music, and noise \
information. Noise information included maximum decibel level (MDL), Peak \
level (LCPeak), Equivalent continuous sound pressure level, time weighted \
average (TWA), dose, and projected dose. Noise measurements were compared \
with baseline controls with and without music (empty ORs).     Results     \
Two hundred seven noise recordings were analyzed. One hundred eighteen of \
those being spinal surgeries, 49 baseline recordings without music, and 40 \
with music. Maximum decibel level reached a maximum value of 111.5 dBA, with \
an average amongst surgical recordings of 103 dBA. Maximum decibel level \
exceeded 85 dBA in 100% of cases and was greater than 100 dBA in 78%. The \
maximum LCPeak recorded was 132.9 dBC with an average of 120 dBC. \
...
article in issue"}, {"DB" -> "Google Scholar", 
  "TI" -> "Impact of cGMP pathway in the peripheral and central hearing \
phenotype of <i>Bdnf <sup>Pax2</sup> </i> KO mice", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.scienceopen.com/hosted-document?doi=10.14293/CGMP.24000015.v1\
", "AB" -> ": found Conference Proceedings : found Is Open Access Impact of \
cGMP pathway in the peripheral and central hearing phenotype of Bdnf Pax2 KO \
mice          Published     conference-abstract                     \
Author(s):     Morgan Hess  1  ,  ,   Dila Calis  1 ,   Wibke Singer  1 ,   \
Lukas R\[UDoubleDot]ttiger  1 ,   Marlies Knipper  1        Publication date \
(Electronic preprint):  10 April 2024        Journal:  cGMP: Generators, \
Effectors and Therapeutic Implications Conference        Conference name: \
cGMP: Generators, Effectors and Therapeutic Implications       Conference \
date: June 28-30, 2024"}, {"DB" -> "Google Scholar", 
  "TI" -> "In silico transcriptome screens identify epidermal growth factor \
receptor inhibitors as therapeutics for noise-induced hearing loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.science.org/doi/abs/10.1126/sciadv.adk2299", 
  "AB" -> ""}, {"DB" -> "Google Scholar", "TI" -> "Human health effects \
associated with occupational and environmental acoustic trauma", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S2772632024000345", 
  "AB" -> "Noise is ubiquitous in daily life and can cause both auditory and \
non-auditory health problems. Noise effects involve both direct and indirect \
pathways through which noise affects human health. A direct pathway \
...
noise nuisance.     Previous article in issue Next article in issue"}, 
 {"DB" -> "Google Scholar", "TI" -> "Personalized Porous Gelatin Methacryloyl \
Sustained&#8208;Release Nicotinamide Protects Against Noise&#8208;Induced \
Hearing Loss", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://onlinelibrary.wiley.com/doi/abs/10.1002/advs.202305682", 
  "AB" -> "There are no Food and Drug Administration-approved drugs for \
treating noise-induced hearing loss (NIHL), reflecting the absence of clear \
specific therapeutic targets and effective delivery strategies. Noise trauma \
is demonstrated results in nicotinamide adenine dinucleotide (NAD+) \
...
delivery, providing new inspiration for drug-based treatment of NIHL.         \
          1"}, {"DB" -> "Google Scholar", "TI" -> "Cochlear zinc signaling \
dysregulation is associated with noise-induced hearing loss, and zinc \
chelation enhances cochlear recovery", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.pnas.org/doi/abs/10.1073/pnas.2310561121", 
  "AB" -> "There are no Food and Drug Administration-approved drugs for \
treating noise-induced hearing loss (NIHL), reflecting the absence of clear \
specific therapeutic targets and effective delivery strategies. Noise trauma \
is demonstrated results in nicotinamide adenine dinucleotide (NAD+) \
...
delivery, providing new inspiration for drug-based treatment of NIHL.         \
          1"}, {"DB" -> "Google Scholar", 
  "TI" -> "Cochlear Changes After Noise Trauma", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/chapter/10.1007/978-3-031-35647-6_10", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Age-related hearing loss", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.nejm.org/doi/full/10.1056/NEJMcp2306778", 
  "AB" -> "Notes Supplementary Material          Information & Authors \
Metrics & Citations Get Access References Media Tables Share          \
Abstract     Hearing progressively declines with age, manifesting initially \
as difficulty understanding speech in background noise and detrimentally \
affecting social functioning. Strategies and technologies can increase \
speech-signal clarity.                             Continue reading this \
article       Select an option below:                       Create your \
account to get 2 free subscriber-only articles each month.    Get Free Access \
Now           Subscribe For Full Access                  Already have an \
account?    Sign In    Print subscriber?    Activate your online access.      \
                             Are you a member of an institution such as a \
university or hospital?       Learn more about Institutional Access           \
      Notes     Disclosure forms provided by the author are available with \
the full text of this article at NEJM.org. Supplementary Material          \
Disclosure Forms (nejmcp2306778_disclosures.pdf)          Download 1.20 MB    \
      Information & Authors Information Published In          New England \
Journal of Medicine     Volume 390 \[Bullet] Number 16 \[Bullet] April 25, \
2024     Pages : 1505 - 1512 Editor     Patrick G. O\[CloseCurlyQuote]Malley \
, M.D., M.P.H. , Editor Copyright     Copyright \[Copyright] 2024 \
Massachusetts Medical Society. All rights reserved.     For personal use \
only. Any commercial reuse of NEJM Group content requires permission . \
Translation     Chinese Translation \:4e2d\:6587\:7ffb\:8bd1 History     \
Published online : April 24, 2024     Published in issue : April 25, 2024 \
Topics          Clinical Medicine General Dementia/Alzheimer Disease \
(Neurology/Neurosurgery) Emergency Medicine General Geriatrics/Aging General \
Neurology/Neurosurgery General Otolaryngology General Outpatient-Based \
Clinical Medicine Rehabilitation Authors Authors     Frank R. Lin , M.D., \
Ph.D. Affiliations     From the Department of Otolaryngology\[Dash]Head and \
Neck Surgery, Johns Hopkins University School of Medicine, Baltimore. Notes   \
  Dr. Lin can be contacted at [email\[NonBreakingSpace]protected] or at the \
Department of Otolaryngology\[Dash]Head and Neck Surgery, Johns Hopkins \
School of Medicine, JHOC 6210, 601 N. Caroline St., Baltimore, MD 21287.     \
Metrics & Citations Metrics          Altmetrics                Citations    \
Export citation              Select the format you want to export the \
citation of this publication.         Format* Please Select       RIS \
(ProCite, Reference Manager) EndNote BibTex Medlars RefWorks       Please \
select an item in the list         Direct Import       Export citation        \
      Cited by             Jacqueline Cavendish, Lynne J Goebel, Musical \
Hallucinations in an Elderly Female With Hearing Loss, Cureus, (2024). \
...
https://doi.org/10.3390/audi"}, {"DB" -> "Google Scholar", 
  "TI" -> "Effects of Musical Training in Music Therapy Following Cochlear \
Implantation&#8212;A Case Report", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", "AID" -> "https://www.mdpi.com/2039-4349/14/2/20", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
...
Advanced Search                                           Section             \
 ...
 {"DB" -> "Google Scholar", "TI" -> "Automated hearing loss type \
classification based on pure tone audiometry data", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.nature.com/articles/s41598-024-64310-2", 
  "AB" -> "Hearing problems are commonly diagnosed with the use of tonal \
...
levels of hearing loss in the better hearing ear. WH"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> "Hearing Loss-Related Altered Neuronal Activity in the Inferior \
Colliculus.", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0378595524000868", 
  "AB" -> "Hearing problems are commonly diagnosed with the use of tonal \
audiometry, which measures a patient\[CloseCurlyQuote]s hearing threshold in \
both air and bone conduction at various frequencies. Results of audiometry \
tests, usually represented graphically in the form of an audiogram, need to \
...
worldwide, of whom 430\[NonBreakingSpace]million have moderate or higher \
levels of hearing loss in the better hearing ear. WH"}, 
 {"DB" -> "Google Scholar", "TI" -> "The perception of emotion in music by \
people with hearing loss and people with cochlear implants", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://royalsocietypublishing.org/doi/abs/10.1098/rstb.2023.0258\
", "AB" -> "Music is an important part of life for many people. It can evoke \
a wide range of emotions, including sadness, happiness, anger, tension, \
...
problems and"}, {"DB" -> "Google Scholar", "TI" -> "Case Reports of Two \
Patients with Sudden Hearing Loss: Idiopathic and Traumatic Brain Injury \
(TBI)", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://ir.library.illinoisstate.edu/aucpcsd/43/", 
  "AB" -> "Abstract 1"}, {"DB" -> "Google Scholar", 
  "TI" -> "How &#39;hidden hearing loss&#39; noise exposure affects neural \
coding in the inferior colliculus of rats", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0378595524000169", 
  "AB" -> "Exposure to brief, intense sound can produce profound changes in \
...
Next article in issue"}, {"DB" -> "Google Scholar", 
  "TI" -> "The Role of Auditory Deprivation", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/chapter/10.1007/978-3-031-35647-6_13", 
  "AB" -> "Hearing loss is the most important factor in the development of \
tinnitus. This chapter describes the changes that occur in the central \
auditory system as a consequence of hearing loss. Deprivation of input to the \
auditory system can cause two types of functional changes: it can alter the \
balance between inhibition and excitation, and it can activate neuronal \
plasticity. Any type of hearing loss, such as conductive or sensorineural \
hearing loss, results in decreased input to the central auditory nervous \
system. Noise-induced hearing loss is an example of auditory deprivation and \
overuse, which in turn can activate neural plasticity. An altered balance \
between inhibition and excitation can change the gain in the central auditory \
system. If the gain is increased, this can lead to hyperactivity in the form \
of tinnitus. The effects on the balance between inhibition and excitation may \
subside when normal input to the auditory system occurs. However, activation \
of neuronal plasticity that may occur as a result of sensory stimulation may \
persist even after normal sensory stimulation is restored. Plastic changes \
may become permanent, and reversal of neuronal plasticity may require special \
measures.          Aage R. M\[OSlash]ller has died before the publication of \
this book.                    This is a preview of subscription content, log \
...
References"}, {"DB" -> "Google Scholar", 
  "TI" -> "Neuroplasticity of the Auditory System", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/chapter/10.1007/978-3-031-35647-6_14", 
  "AB" -> "Plasticity occurs at various time scales. In addition to neuronal \
spike-firing adaptation at a relatively short time scale, central neural \
responses can be decreased over much longer time periods, e.g., as in \
habituation. In particular, spectrotemporal receptive fields might have \
slower timescales of adaptation on the order of minutes to hours. A common \
hypothesis is that tinnitus results from a maladaptive imbalance between \
excitation and inhibition as a result of downregulation of inhibitory amino \
acid neurotransmission in the central auditory pathway. However, the effects \
of neural plasticity underlying noise exposure do not need to be maladaptive \
because the chronic tinnitus percept may be the result of \
experience-dependent plasticity with a percept engrained in memory as a \
...
Open acce"}, {"DB" -> "Google Scholar", "TI" -> "Transcriptional response to \
mild therapeutic hypothermia in noise-induced cochlear injury", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.frontiersin.org/articles/10.3389/fnins.2023.1296475/full", 
  "AB" -> "1 Introduction 2 Materials and methods 3 Results 4 Discussion 5 \
Conclusion Data availability statement Ethics statement Author contributions \
Funding Acknowledgments Conflict of interest Publisher\[CloseCurlyQuote]s \
note Supplementary material Footnotes References      Export citation         \
...
Neurosci. , 17 January 2024      Sec. Translational Neuroscience      Volume \
17 - 2023 |  https://doi.org/10.3389/fnins.2023.1296475       This article is \
part of the Research Topic Inner Ear Therapeutics: The Road to Hearing \
Rehabilitation and Restoration View all 7 articles          Transcriptional \
response to mild therapeutic hypothermia in noise-induced cochlear injury     \
            Samantha Rincon Sabatino 1  Rachele Sangaletti 2  Anthony \
Griswold 3  W. Dalton Dietrich 4  Curtis S. King 5  Suhrud M. Rajguru 1,2,4,5 \
*     1 Department of Biomedical Engineering, University of Miami, Coral \
Gables, FL, United States 2 Department of Otolaryngology, University of \
Miami, Coral Gables, FL, United States 3 Department of Human Genetics, \
University of Miami, Coral Gables, FL, United States 4 The Miami Project to \
Cure Paralysis, University of Miami, Coral Gables, FL, United States 5 \
RestorEar Devices LLC, Bozeman, MT, United States       Introduction: \
Prevention or treatment for acoustic injury has been met with many \
translational challenges, resulting in the absence of FDA-approved \
interventions. Localized hypothermia following noise exposure mitigates acute \
cochlear injury and may serve as a potential avenue for therapeutic \
approaches. However, the mechanisms by which hypothermia results in \
therapeutic improvements are poorly understood.       Methods: This study \
performs the transcriptomic analysis of cochleae from juvenile rats that \
experienced noise-induced hearing loss (NIHL) followed by hypothermia or \
control normothermia treatment.       Results: Differential gene expression \
results from RNA sequencing at 24\[ThinSpace]h post-exposure to noise suggest \
that NIHL alone results in increased inflammatory and immune defense \
responses, involving complement activation and cytokine-mediated signaling. \
Hypothermia treatment post-noise, in turn, may mitigate the acute \
...
viable otopro"}, {"DB" -> "Google Scholar", "TI" -> "Murine Cochlear Damage \
Models in the Context of Hair Cell Regeneration Research", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0378595524000741", 
  "AB" -> "Understanding the complex pathologies associated with hearing loss \
is a significant motivation for conducting inner ear research. Lifelong \
exposure to loud noise, ototoxic drugs, genetic diversity, sex, and aging \
collectively contribute to human hearing loss. Replicating this pathology in \
research animals is challenging because hearing impairment has varied causes \
and different manifestations. A central aspect, however, is the loss of \
sensory hair cells and the inability of the mammalian cochlea to replace \
them. Researching therapeutic strategies to rekindle regenerative cochlear \
capacity, therefore, requires the generation of animal models in which \
cochlear hair cells are eliminated. This review discusses different \
...
all open access content, the Creative Commons licensing terms apply."}, 
 {"DB" -> "Google Scholar", "TI" -> "Time-dependent effects of acoustic \
trauma and tinnitus on extracellular levels of amino acids in the inferior \
colliculus of rats", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", 
  "PT" -> "", "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0378595524000017", 
  "AB" -> "Chronic tinnitus is a debilitating condition with very few \
...
resolution of the microdialysis compared to electrophysiological responses.   \
 ...
 {"DB" -> "Google Scholar", "TI" -> "Norepinephrine protects against cochlear \
outer hair cell damage and noise-induced hearing loss via &#945;", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://bmcneurosci.biomedcentral.com/counter/pdf/10.1186/s12868-\
024-00845-4.pdf", "AB" -> "no abstract available"}, 
 {"DB" -> "Google Scholar", "TI" -> "A novel model of sensorineural hearing \
loss induced by repeated exposure to moderate noise in mice: the preventive \
effect of resveratrol", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", 
  "PT" -> "", "AID" -> "https://www.jstage.jst.go.jp/article/jvms/86/4/86_23-\
0477/_article/-char/ja/", "AB" -> "no abstract available"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> 
   "Hydralazine alleviates noise-induced hearing loss by scavenging acrolein"\
, "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0304394023004998", 
  "AB" -> "Noise-induced hearing loss (NIHL) is the most common cause of \
...
Previous article in issue Next article in issue"}, 
 {"DB" -> "Google Scholar", "TI" -> "Associations Between Auditory Working \
Memory, Self-Perceived Listening Effort, and Hearing Difficulty in Adults \
With Mild Traumatic Brain Injury", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", "AID" -> "https://journals.lww.com/ear-hearing/full\
text/2024/05000/associations_between_auditory_working_memory,.15.aspx", 
  "AB" -> "Noise-induced hearing loss (NIHL) is the most common cause of \
hearing loss. This study investigates the therapeutic efficacy of the \
acrolein scavenger hydralazine for NIHL in rats. NIHL was induced by exposure \
to a continuous pure tone of 10\[NonBreakingSpace]kHz. Auditory function was \
...
NIHL, it\[CloseCurlyQuote]s also a therapeutic potential target for NIHL.     \
Previous article in issue Next article in issue"}, 
 {"DB" -> "Google Scholar", "TI" -> "Hair cell regeneration, reinnervation, \
and restoration of hearing thresholds in the avian hearing organ", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.cell.com/cell-reports/fulltext/S2211-1247(24)00150-5", 
  "AB" -> "Article title, abstract, keywords     Search within: This journal \
Full site Advanced search          Please enter a term before submitting your \
search. Ok                                                            \
...
abstract"}, {"DB" -> "Google Scholar", "TI" -> "Efficacy of Amplification for \
Tinnitus Relief in People With Mild Hearing Loss", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://pubs.asha.org/doi/abs/10.1044/2023_JSLHR-23-00031", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Examining the Use and Benefits of Low-/Mild-Gain Hearing Aids in \
Service Members with Normal Hearing Thresholds and Self-Reported Hearing \
Difficulties", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.mdpi.com/2227-9032/12/5/578", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
Clinicopathological Challenge Comment Commentary Concept Paper Conference \
Report Correction Creative Data Descriptor Discussion Entry Essay Expression \
of Concern Extended Abstract Field Guide Giants in Urology Guidelines \
...
Advanced Search                                           Section             \
           ...
           Number                 Page                                        \
              Logical Operator Operator   AND OR               Search Text    \
             Search Type   All fields Title Abstract"}, 
 {"DB" -> "Google Scholar", "TI" -> "KSR1 knockout mouse model demonstrates \
MAPK pathway&#39;s key role in cisplatin-and noise-induced hearing loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.jneurosci.org/content/44/18/e2174232024.abstract", 
  "AB" -> "Hearing loss is a major disability in everyday life and \
...
Role in Cisplatin- and Noise-induced Hearing Loss           Message S"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> "Contemporary mechanics of conductive hearing loss", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S1043181024000010", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Role of Oxidative Stress in Sensorineural Hearing Loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.mdpi.com/1422-0067/25/8/4146", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
Clinicopathological Challenge Comment Commentary Concept Paper Conference \
Report Correction Creative Data Descriptor Discussion Entry Essay Expression \
of Concern Extended Abstract Field Guide Giants in Urology Guidelines \
...
Advanced Search                                           Section             \
           ...
           Number                 Page                                        \
              Logical Operator Operator   AND OR               Search Text    \
             Search Type   All fields Title Abstract"}, 
 {"DB" -> "Google Scholar", "TI" -> "Early transtympanic administration of \
rhBDNF exerts a multifaceted neuroprotective effect against \
cisplatin&#8208;induced hearing loss", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> "https://bpspubs.onlinelibrary.wiley.com/doi/abs/10.1111/bph.17359\
", "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "PKHD1L1 is Required for Stereocilia Bundle Maintenance, Prolonged \
Hearing Function and Enhanced Resilience to Noise Exposure.", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://europepmc.org/article/pmc/pmc10942330", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Hidden hearing loss: Fifteen years at a glance", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0378595524000200", 
  "AB" -> "Hearing loss affects approximately 18% of the population \
worldwide. Hearing difficulties in noisy environments without accompanying \
audiometric threshold shifts likely affect an even larger percentage of the \
global population. One of the potential causes of hidden hearing loss is \
cochlear synaptopathy, the loss of synapses between inner hair cells (IHC) \
and auditory nerve fibers (ANF). These synapses are the most vulnerable \
structures in the cochlea to noise exposure or aging. The loss of synapses \
causes auditory deafferentation, i.e., the loss of auditory afferent \
information, whose downstream effect is the loss of information that is sent \
to higher-order auditory processing stages. Understanding the physiological \
and perceptual effects of this early auditory deafferentation might inform \
interventions to prevent later, more severe hearing loss.     In the past \
decade, a large body of work has been devoted to better understand hidden \
hearing loss, including the causes of hidden hearing loss, their \
...
Commons licensing terms apply."}, {"DB" -> "Google Scholar", 
  "TI" -> "NcRNA: key and potential in hearing loss", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.frontiersin.org/articles/10.3389/fnins.2023.1333131/full", 
  "AB" -> "1 Introduction 2 MiR-183 family in hearing loss 3 MiR-34a in \
hearing loss 4 Other miRNAs in hearing loss 5 LncRNA in hearing loss 6 \
Discussion and prospect Author contributions Funding Conflict of interest \
Publisher\[CloseCurlyQuote]s note Abbreviations References        Export \
citation           EndNote   Reference Manager   Simple Text file   BibTex    \
       Check for updates            Download article           Download       \
Download PDF   ReadCube   EPUB   XML (NLM)           REVIEW article     \
Front. Neurosci. , 17 January 2024      Sec. Auditory Cognitive Neuroscience  \
    Volume 17 - 2023 |  https://doi.org/10.3389/fnins.2023.1333131       This \
article is part of the Research Topic Gene Therapy for Hearing Loss: From \
Mechanism to Clinic, volume II View all 15 articles          NcRNA: key and \
potential in hearing loss                     Keyu Zhu 1\[Dagger]  Ting Wang \
2\[Dagger]  Sicheng Li 3\[Dagger]  Zeming Liu 1  Yuanyuan Zhan 1*  Qi Zhang \
1*       1 Department of Plastic and Cosmetic Surgery, Tongji Hospital, \
Tongji Medical College, Huazhong University of Science and Technology, Wuhan, \
China 2 Department of Medical Ultrasound, Tongji Hospital of Tongji Medical \
College of Huazhong University of Science and Technology, Wuhan, China 3 \
Department of Plastic Surgery, Renmin Hospital of Wuhan University, Wuhan, \
Hubei, China       Hearing loss has an extremely high prevalence worldwide \
and brings incredible economic and social burdens. Mechanisms such as \
epigenetics are profoundly involved in the initiation and progression of \
hearing loss and potentially yield definite strategies for hearing loss \
treatment. Non-coding genes occupy 97% of the human genome, and their \
transcripts, non-coding RNAs (ncRNAs), are widely participated in regulating \
various physiological and pathological situations. NcRNAs, mainly including \
micro-RNAs (miRNAs), long-stranded non-coding RNAs (lncRNAs), and circular \
RNAs (circRNAs), are involved in the regulation of cell metabolism and cell \
death by modulating gene expression and protein-protein interactions, thus \
impacting the occurrence and prognosis of hearing loss. This review provides \
a detailed overview of ncRNAs, especially miRNAs and lncRNAs, in the \
pathogenesis of hearing loss. We also discuss the shortcomings and issues \
that need to be addressed in the study of hearing loss ncRNAs in the hope of \
providing viable therapeutic strategies for the precise treatment of hearing \
loss.                 1 Introduction       Based on the Global Burden of \
Disease (GBD) study, deafness is the third major cause of disability in the \
world, which affects more than 5% of the population overworld ( Tyrovolas et \
al., 2022 ). Meanwhile, more people are suffering from mild, undiagnosed \
hearing loss. About 1.57 billion of the world population were impacted by \
hearing loss, a number that could grow to 2.45 billion by 2050 ( Haile et \
al., 2021 ). Thus, hearing loss is an emerging serious problem. The World \
Health Organization (WHO) classifies hearing loss as mild, moderat"}, 
 {"DB" -> "Google Scholar", "TI" -> "Historical Article: Settling the Dispute \
of Romantic Composer Bed&#345;ich Smetana&#39;s Neurological Deterioration", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.cambridge.org/core/journals/journal-of-laryngology-an\
d-otology/article/historical-article-settling-the-dispute-of-romantic-compose\
r-bedrich-smetanas-neurological-deterioration/B4D79648BF12F523EC8CE40DD4A99C3\
C", "AB" -> "1 Introduction 2 MiR-183 family in hearing loss 3 MiR-34a in \
hearing loss 4 Other miRNAs in hearing loss 5 LncRNA in hearing loss 6 \
Discussion and prospect Author contributions Funding Conflict of interest \
Publisher\[CloseCurlyQuote]s note Abbreviations References        Export \
citation           EndNote   Reference Manager   Simple Text file   BibTex    \
...
Health Organization (WHO) classifies hearing loss as mild, moderat"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> "Conductive and Sensorineural Hearing Loss", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/chapter/10.1007/978-3-031-35647-6_32", 
  "AB" -> "Hearing loss is the symptom most commonly seen in association with \
tinnitus. According to the various models of tinnitus development, hearing \
loss also represents the crucial trigger mechanism for the development of \
tinnitus. Since different structures such as the outer ear, the middle ear \
and the inner ear are involved in the peripheral hearing process, a \
distinction is also made between conductive hearing loss, sensorineural \
hearing loss and retrocochlear hearing loss, depending on the localization of \
the pathology. This chapter highlights the main causes of conductive hearing \
loss and sensorineural hearing loss. A detailed clarification of the causes \
of hearing loss in tinnitus is important, as in many cases this also leads to \
specific therapies, which ideally will result in an improvement of hearing \
loss and tinnitus symptoms. In the case of middle ear hearing loss, these \
therapeutic approaches are primarily surgical in nature (tympanoplasty, \
stapes surgery), in the case of sensorineural hearing loss, the improvement \
is generally based on a prosthetic fitting with hearing aids or cochlear \
implants. Graphical Abstract                              This is a preview \
of subscription content, log in via an institution       to check access.     \
       Access this chapter           Log in via an institution                \
                     Subscribe and save                         Springer+ \
Basic          \[Euro]34.99 /Month          Get 10 units per month Download \
Article/Chapter or eBook 1 Unit = 1 Article or 1 Chapter Cancel anytime \
Subscribe now           Buy Now                             Chapter         \
EUR\[NonBreakingSpace]29.95     Price includes VAT (Germany)            \
Available as PDF Read on any device Instant download Own it forever   Buy \
Chapter                       eBook   EUR\[NonBreakingSpace]136.95   Price \
includes VAT (Germany)            Available as EPUB and PDF Read on any \
...
Thresholds            Article   10 April 2018                     Notes       \
 ...
 {"DB" -> "Google Scholar", "TI" -> "Noise induces intercellular Ca2+ \
signaling waves and the unfolded protein response in the hearing cochlea", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.biorxiv.org/content/10.1101/2024.06.05.597671.abstract", 
  "AB" -> "Full Text Info/History Metrics Supplementary material Preview PDF  \
                                                                          \
Abstract     Exposure to loud noise is a common cause of acquired hearing \
loss. Disruption of subcellular calcium homeostasis and downstream stress \
pathways in the endoplasmic reticulum and mitochondria, including the \
unfolded protein response, have been implicated in the pathophysiology of \
noise-induced hearing loss. However, studies on the association between \
calcium homeostasis and stress pathways has been limited due to limited \
ability to measure calcium dynamics in mature-hearing, noise-exposed mice. We \
used a genetically encoded calcium indicator mouse model in which GcAMP is \
expressed specifically in hair cells or supporting cells under control of \
Myo15Cre or Sox2Cre, respectively. We performed live calcium imaging and UPR \
gene expression analysis in 8-week-old mice exposed to levels of noise that \
cause cochlear synaptopathy (98 db SPL) or permanent hearing loss (106 dB \
SPL). UPR activation occurred immediately after noise exposure and was noise \
...
2024.                                                               D"}, 
 {"DB" -> "Google Scholar", 
  ...
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.jpmi.org.pk/index.php/jpmi/article/view/3267", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Taringa Whakarongo: Kaum&#257;tua &amp; wh&#257;nau experiences of \
hearing loss &amp; hearing healthcare in T&#257;maki Makaurau", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.tandfonline.com/doi/abs/10.1080/03036758.2024.2424793\
", "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> 
   "Hearing Conservation Program Implementation for University Musicians", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://repository.arizona.edu/handle/10150/672684", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Occupational noise-induced hearing loss among dental personnel: a \
scoping review", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.nature.com/articles/s41415-024-7613-3", "AB" -> ""}, 
 {"DB" -> "Google Scholar", "TI" -> "Examining the utility of near infrared \
light as pre-exposure therapy to mitigate temporary noise-induced hearing \
loss in humans", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.frontiersin.org/articles/10.3389/fneur.2024.1366239/full", 
  "AB" -> "Introduction Methods Results Discussion Data availability \
...
, {"DB" -> "Google Scholar", "TI" -> "What is the safe noise exposure level \
to prevent noise-induced hearing loss?", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.nature.com/articles/s41370-024-00660-3", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Are Current Data Sufficient to Infer that Hearing Aids Contribute \
to Postural Control and Balance in Older Adults? A Systematic Review", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://karger.com/fpl/article/76/3/232/863001", 
  "AB" -> "Introduction             Methods             Results             \
Discussion             Acknowledgments             Statement of Ethics        \
     Conflict of Interest Statement             Funding Sources             \
Author Contributions             Data Availability Statement             \
References                                              Article Navigation    \
                          Systematic Review |   September 15 2023            \
Are Current Data Sufficient to Infer that Hearing Aids Contribute to Postural \
Control and Balance in Older Adults? A Systematic Review                 \
Subject Area:     Audiology and Speech   ,     Further Areas                  \
       Limor Lavie ;                          Limor Lavie  *                 \
Department of Communication Sciences and Disorders, University of Haifa, \
Haifa, Israel               [email\[NonBreakingSpace]protected]          \
Search for other works by this author on:          This Site           PubMed \
          Google Scholar                Nawras Tobia ;                        \
  Nawras Tobia                Department of Communication Sciences and \
Disorders, University of Haifa, Haifa, Israel          Search for other works \
by this author on:          This Site           PubMed           Google \
Scholar                Neta Slav-Zarfati ;                          Neta \
Slav-Zarfati                Department of Communication Sciences and \
Disorders, University of Haifa, Haifa, Israel          Search for other works \
by this author on:          This Site           PubMed           Google \
Scholar                Shefi Castel ;                          Shefi Castel   \
             Department of Communication Sciences and Disorders, University \
of Haifa, Haifa, Israel          Search for other works by this author on:    \
      This Site           PubMed           Google Scholar                \
Karen Banai                          Karen Banai                Department of \
...
Cite Icon     Cite"}, {"DB" -> "Google Scholar", 
  "TI" -> "Central Gain Model for Tinnitus: A Review on Noise-Induced \
Plasticity or When Less at the Periphery Is More in the Center", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/chapter/10.1007/978-3-031-35647-6_18", 
  "AB" -> "Hearing loss represents a major sensory deficit as it is largely \
prevalent in the general population and can dramatically impair quality of \
life. One of the most prevalent causes of sensorineural hearing loss is noise \
exposure. Noise-induced hearing loss (NIHL) is the second most common form of \
the sensorineural hearing deficit, after age-related hearing loss. \
Importantly, it induces neuropathophysiological alterations in the auditory \
system, which can result in the generation of \[OpenCurlyDoubleQuote]aberrant \
auditory perceptions\[CloseCurlyDoubleQuote] such as tinnitus or hyperacusis. \
Here, we review the central plasticity that is triggered by noise-induced \
hearing loss. In brief, there is overwhelming evidence that noise-induced \
hearing loss is associated to compensatory mechanisms in the auditory \
centers: while the sensory inputs are reduced at the periphery (i.e., in the \
cochlear nerve), they are enhanced at virtually all levels of the auditory \
centers. A vast repertoire of molecular mechanisms are involved in these \
functional changes. It is plausible that these peripherally triggered central \
changes can result in tinnitus and/or hyperacusis. Graphical Abstract         \
...
https://doi.org/10.1179/000349809X12459740922372 .     Article"}, 
 {"DB" -> "Google Scholar", "TI" -> "A qualitative study assessing the \
barriers and facilitators to physical activity in adults with hearing loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://bpspsychub.onlinelibrary.wiley.com/doi/abs/10.1111/bjhp.12689", 
  "AB" -> "Objectives       Growing epidemiological evidence has shown \
...
hearing loss are also at a greater risk of"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> "Gene therapy for hearing loss: From mechanism to clinic, volume \
II", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://books.google.de/books?hl=de&amp;lr=&amp;id=osYJEQAAQBAJ&a\
mp;oi=fnd&amp;pg=PP1&amp;dq=(hearing+loss+OR+hearing+impairment+OR+hearing+di\
fficulties+OR+acoustic+trauma)+AND+(musician)&amp;ots=V9Q8MDRki7&amp;sig=bhzc\
E0cnIFCZ4OdwbrWSC5vISs8", "AB" -> "no abstract available"}, 
 {"DB" -> "Google Scholar", "TI" -> "Functional hearing difficulties in \
blast-exposed service members with normal to near-normal hearing thresholds", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.lww.com/ear-hearing/fulltext/2024/01000/function\
al_hearing_difficulties_in_blast_exposed.12.aspx", 
  "AB" -> "Next   Abstract                                                    \
                                                              Article as EPUB \
...
multiple e-mails with a (;).                Message:           Thought you \
might appreciate this item(s) I saw in Ear and Hearing.                       \
                                                                              \
...
have hearing thresholds slightly above the normal"}, 
 {"DB" -> "Google Scholar", "TI" -> "Effects on hearing after long-term use \
of iron chelators in beta-thalassemia: Over twenty years of longitudinal \
follow-up", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0385814623001864", 
  "AB" -> "Objective     The role of iron chelation in causing hearing loss \
(HL) is still unclear. The present study assessed the prevalence of HL among \
...
Previous article in issue Next article in issue"}, 
 {"DB" -> "Google Scholar", "TI" -> "Tinnitus", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", "AID" -> "https://www.taylorfrancis.com\
/chapters/edit/10.1201/9781003436812-20/tinnitus-robert-thayer-sataloff-camry\
n-marshall", "AB" -> "Tinnitus is the perception of noise in the ear for \
head. Subjective tinnitus is heard by the patient only, whereas objective \
tinnitus can be heard by the observer. Objective tinnitus is much less common \
than subjective tinnitus. Tinnitus often is associated with hearing loss, but \
...
Top"}, {"DB" -> "Google Scholar", "TI" -> "Drug screening identifies aldose \
reductase as a novel target for treating cisplatin-induced hearing loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0891584923011267", 
  "AB" -> "Cisplatin is a frequently used chemotherapeutic medicine for \
cancer treatment. Permanent hearing loss is one of the most serious side \
...
full-size image     Previous article in issue Next article in issue"}, 
 {"DB" -> "Google Scholar", "TI" -> "A systematic review of the association \
of Type I diabetes with sensorineural hearing loss", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0298457\
", "AB" -> "Objectives       Type 1 diabetes (T1D) has been associated with \
several comorbidities such as ocular, renal, and cardiovascular \
...
files.     Funding: The author(s) received no specific funding for this work. \
    Competing i"}, {"DB" -> "Google Scholar", "TI" -> "Robotic assistance \
during cochlear implantation: the rationale for consistent, controlled speed \
of electrode array insertion", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.frontiersin.org/articles/10.3389/fneur.2024.1335994/full", 
  "AB" -> "Introduction A slow and consistent EA insertion speed reduces \
insertion forces and intracochlear pressure spikes Reduced insertion speed \
and forces limit intracochlear trauma Reduced insertion trauma may improve \
hearing outcomes The significance of consistent, controlled speed Current \
state of robotics-assistance platforms and future directions Conclusion \
...
remaining acoustic hearing, as it was thought"}, 
 {"DB" -> "Google Scholar", "TI" -> "Machine Learning Based Dynamic Band \
Selection for Splitting Auditory Signals to Reduce Inner Ear Hearing Losses", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.academia.edu/download/112754429/6075.pdf", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Exploring sensory processing abilities in adults with acquired \
hearing loss", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.cambridge.org/core/journals/journal-of-laryngology-an\
d-otology/article/exploring-sensory-processing-abilities-in-adults-with-acqui\
red-hearing-loss/6A579A64B588D3ECB3C25F9A4C5C9223", 
  "AB" -> "Objectives     Method     Results     Conclusion     Introduction  \
   Materials and methods     Results     Discussion     Conclusion     \
Competing interests Footnotes References          Exploring sensory \
processing abilities in adults with acquired hearing loss            \
Published online by Cambridge University Press: 05 October 2023           \
Bilgehan Tekin Dal  [Opens in a new window] ,     Binnur \
\[CapitalCCedilla]etin  ,     Eda Nur \:015eim\:015fek  and     Gonca Bumin   \
    Show author details           Bilgehan Tekin Dal* Affiliation:     \
Department of Audiology, Faculty of Health Sciences, Gazi University, Ankara, \
Turkey       Binnur \[CapitalCCedilla]etin Affiliation:     Department of \
Occupational Therapy, Fizikon Medical Center, Konya, Turkey       Eda Nur \
\:015eim\:015fek Affiliation:     Department of Audiology, Kayseri \
Ac\[DotlessI]badem Hospital, Kayseri, Turkey       Gonca Bumin Affiliation:   \
  Department of Occupational Therapy, Faculty of Health Sciences, Hacettepe \
University, Ankara, Turkey        *           Corresponding author: Bilgehan \
Tekin Dal; Email: bilgehantekindal@gazi.edu.tr          Article  Figures  \
Metrics           Article contents      Abstract Objectives Method Results \
Conclusion Introduction Materials and methods Results Discussion Conclusion \
Competing interests Footnotes References           Save PDF           Save \
PDF (0.14 mb)   View PDF  [Opens in a new window]   Save to Dropbox  Save to \
Google Drive  Save to Kindle       Share            Cite   Rights & \
Permissions  [Opens in a new window]          Abstract           Objectives   \
  This study aimed to evaluate the sensory processing abilities of adults \
with acquired hearing loss and determine whether their sensory processing \
patterns differ from those of the general population and adults with normal \
hearing.     Method     The study evaluated the sensory processing functions \
of 30 adults with acquired hearing loss using the Adolescent/Adult Sensory \
Profile and compared them with the sensory processing functions of 30 adults \
with normal hearing.     Results     The results showed that individuals with \
hearing loss have a significantly higher sensitivity to stimuli related to \
motion, vision, activity and touch, exhibiting a low-registration sensory \
pattern and a sensation-avoiding pattern that differed from those of most \
individuals.     Conclusion     Assessing sensory processing profiles can \
help identify specific sensory difficulties and inform individualised \
treatment plans. The study highlights the importance of considering sensory \
processing patterns in the management of hearing loss to improve overall \
well-being and quality of life for adults with hearing loss."}, 
 {"DB" -> "Google Scholar", "TI" -> "Sound-Evoked Neural Activity in Normal \
Hearing Tinnitus: The Effect of Frequency and Simulation Side", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.preprints.org/manuscript/202404.1172", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "FOXO1&#8208;NCOA4 Axis contributes to cisplatin&#8208;induced \
cochlea spiral ganglion neuron ferroptosis via ferritinophagy", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://onlinelibrary.wiley.com/doi/abs/10.1002/advs.202402671", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Effects of Astragaloside IV on Hearing, Inflammatory Factors, and \
Intestinal Flora in Mice Exposed to Noise", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.mdpi.com/2218-1989/14/2/122", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
Clinicopathological Challenge Comment Commentary Concept Paper Conference \
Report Correction Creative Data Descriptor Discussion Entry Essay Expression \
of Concern Extended Abstract Field Guide Giants in Urology Guidelines \
...
Advanced Search                                           Section             \
           ...
           Number                 Page                                        \
              Logical Operator Operator   AND OR               Search Text    \
             Search Type   All fields Title Abstract"}, 
 {"DB" -> "Google Scholar", "TI" -> "Advancing noise management in aviation: \
Strategic approaches for preventing noise-induced hearing loss", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0301479724013999", 
  "AB" -> "As urbanization and population growth escalate, the challenge of \
...
aviation sector.     Previous article in issue Next article in issue"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> "Music Perception in Bone&#8208;Anchored Hearing Implant Users", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://onlinelibrary.wiley.com/doi/abs/10.1002/lary.30919", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "The effects of acute and chronic noise trauma on stimulus-evoked \
activity across primary auditory cortex layers", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.physiology.org/doi/abs/10.1152/jn.00427.2022", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Loud and unwanted: Individual differences in the tolerance for \
exposure to music", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", 
  "PT" -> "", "AID" -> 
   "https://pubs.aip.org/asa/jasa/article/155/5/3274/3293862", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Sound-Evoked Neural Activity in Normal-Hearing Tinnitus: Effects \
of Frequency and Stimulated Ear Side", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", "AID" -> "https://www.mdpi.com/2076-3425/14/6/544", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
Clinicopathological Challenge Comment Commentary Concept Paper Conference \
Report Correction Creative Data Descriptor Discussion Entry Essay Expression \
of Concern Extended Abstract Field Guide Giants in Urology Guidelines \
...
Advanced Search                                           Section             \
           ...
           Number                 Page                                        \
              Logical Operator Operator   AND OR               Search Text    \
             Search Type   All fields Title Abstract"}, 
 {"DB" -> "Google Scholar", "TI" -> "Modelling the recovery of residual \
acoustic hearing after cochlear implantation by using feasible intracochlear \
acoustic devices", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", 
  "PT" -> "", "AID" -> 
   "https://pubs.aip.org/aip/acp/article-abstract/3062/1/040012/3267446", 
  "AB" -> "ing & Indexing     Ethics Policy     FAQ for Organizers     Peer \
Review     The Publication Process     Post Publication Policy     \
Testimonials from Editors & Organizers     How To Redeem Access Codes       \
About         Overview     Journal Development Team     Contact               \
                   Skip Nav Destination                       Close \
navigation menu         Article navigation                                   \
Volume 3062, Issue 1            27 February 2024                             \
NONLINEARITY AND HEARING: ADVANCES IN THEORY AND EXPERIMENT: Proceedings of \
the 14th International Mechanics of Hearing Workshop     24\[Dash]29 July \
2022     Helsing\[OSlash]r, Denmark                  Previous Article     \
Next Article                               REFERENCES                         \
                                                    Article Navigation        \
                       Research Article |   February 27 2024            \
Modelling the recovery of residual acoustic hearing after cochlear \
implantation by using feasible intracochlear acoustic devices                 \
      David Slater ;                          David Slater  a)                \
      Institute of Sound and Vibration Research, University of Southampton , \
University Road, Southampton SO17 1BJ,     England               a) \
Corresponding author: [email\[NonBreakingSpace]protected]          Search for \
other works by this author on:          This Site           PubMed           \
Google Scholar                Stephen Elliott ;                          \
Stephen Elliott  b)                      Institute of Sound and Vibration \
...
Site           PubMed           Google Scholar                Carl Verschuur  \
                        Carl Verschuur  c)                      Institute of \
Sound and Vibration Research, University of Southampton , University Road, \
Southampton SO17 1BJ,     England          Search for other works by this \
author on:          This Site           PubMed           Google Scholar       \
                       Author & Article Information                           \
   a) Corresponding author: [email\[NonBreakingSpace]protected]               \
        b)     Electronic mail: [email\[NonBreakingSpace]protected]           \
            c)     Electronic mail: [email\[NonBreakingSpace]protected]       \
...
Facebook Reddit LinkedIn       Tools Icon     Tools                           \
 ...
 {"DB" -> "Google Scholar", "TI" -> "Normal Weight Central Obesity is a Poor \
Prognostic Factor for Sudden Sensorineural Hearing Loss", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.sagepub.com/doi/abs/10.1177/00034894231223573", 
  "AB" -> "Data availability statement References Get access More          \
Cite article Share options Information, rights and permissions Metrics and \
...
Scholar          5. Yavuz E, Morawski K, Telischi FF, et a"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> "Prevalence of hearing loss in college students: a meta-analysis", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.frontiersin.org/articles/10.3389/fnins.2023.1282829/full", 
  "AB" -> "Introduction Methods Results Discussion Data availability \
...
colleg"}, {"DB" -> "Google Scholar", 
  "TI" -> "Saynpatic mechanisms of noise-induced hearing loss", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://ediss.uni-goettingen.de/handle/11858/15222", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Gelatin&#8208;Encapsulated Tetrahedral DNA Nanostructure Enhances \
Cellular Internalization for Treating Noise&#8208;Induced Hearing Loss", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://onlinelibrary.wiley.com/doi/abs/10.1002/smll.202310604", 
  "AB" -> "Nanoparticle-based drug delivery strategies have emerged as a \
crucial avenue for comprehensive sensorineural hearing loss treatment. \
Nevertheless, developing therapy vectors crossing both biological and \
cellular barriers has encountered significant challenges deriving from \
various external factors. Herein, the rational integration of gelatin \
nanoparticles (GNPs) with tetrahedral DNA nanostructures (TDNs) to engineer a \
distinct drug-delivery nanosystem (designed as TDN@GNP) efficiently enhances \
the biological permeability and cellular internalization, further resolving \
the dilemma of noise-induced hearing loss via loading epigallocatechin \
gallate (EGCG) with anti-lipid peroxidation property. Rationally engineering \
of TDN@GNP demonstrates dramatic alterations in the physicochemical key \
parameters of TDNs that are pivotal in cell-particle interactions and promote \
cellular uptake through multiple endocytic pathways. Furthermore, the \
EGCG-loaded nanosystem (TDN-EGCG@GNP) facilitates efficient inner ear drug \
delivery by superior permeability through the biological barrier (round \
window membrane), maintaining high drug concentration within the inner ear. \
The TDN-EGCG@GNP actively overcomes the cell membrane, exhibiting hearing \
protection from noise insults via reduced lipid peroxidation in outer hair \
cells and spiral ganglion neurons. This work exemplifies how integrating \
diverse vector functionalities can overcome biological and cellular barriers \
in the inner ear, offering promising applications for inner ear disorders.    \
               1"}, {"DB" -> "Google Scholar", 
  "TI" -> "Parameters influencing auditory fatigue among professionals \
working in the amplified music sector: noise exposure and individual factors"\
, "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.tandfonline.com/doi/abs/10.1080/14992027.2023.2240012\
", "AB" -> "Objective     Hearing disorders are common among music \
...
for hearing."}, {"DB" -> "Google Scholar", "TI" -> "Lercanidipine&#39;s \
Antioxidative Effect Prevents Noise-Induced Hearing Loss", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.mdpi.com/2076-3921/13/3/327", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
Clinicopathological Challenge Comment Commentary Concept Paper Conference \
Report Correction Creative Data Descriptor Discussion Entry Essay Expression \
of Concern Extended Abstract Field Guide Giants in Urology Guidelines \
...
Advanced Search                                           Section             \
           ...
           Number                 Page                                        \
              Logical Operator Operator   AND OR               Search Text    \
             Search Type   All fields Title Abstract"}, 
 {"DB" -> "Google Scholar", "TI" -> "Identification of common stria \
vascularis cellular alteration in sensorineural hearing loss based on \
ScRNA-seq", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/article/10.1186/s12864-024-10122-7", 
  "AB" -> "Background     The stria vascularis (SV), located in the lateral \
wall of the cochlea, maintains cochlear fluid homeostasis and \
mechanoelectrical transduction (MET) activity required for sound wave \
conduction. The pathogenesis of a number of human inheritable deafness \
syndromes, age related hearing loss, drug-induced ototoxicity and \
noise-induced hearing loss results from the morphological changes and \
functional impairments in the development of the SV. In this study, we \
investigate the implications of intercellular communication within the SV in \
the pathogenesis of sensorineural hearing loss (SNHL). We aim to identify \
commonly regulated signaling pathways using publicly available single-cell \
transcriptomic sequencing (scRNA-seq) datasets. Methods     We analyzed \
scRNA-seq data, which was derived from studying the cochlear SV in mice with \
SNHL compared to normal adult mice. After quality control and filtering, we \
obtained the major cellular components of the mouse cochlear SV and \
integrated the data. Using Seurat's FindAllMarkers and FindMarkers packages, \
we searched for novel conservative genes and differential genes. We employed \
KEGG and GSEA to identify molecular pathways that are commonly altered among \
different types of SNHL. We utilized pySCENIC to discover new specific \
regulatory factors in SV subpopulation cells. With the help of CellChat, we \
identified changes in subpopulation cells showing similar trends across \
different SNHL types and their alterations in intercellular communication \
pathways. Results     Through the analysis of the integrated data, we \
discovered new conserved genes to SV specific cells and identified common \
downregulated pathways in three types of SNHL. The enriched genes for these \
pathways showing similar trends are primarily associated with the Electron \
Transport Chain, related to mitochondrial energy metabolism. Using the \
CellChat package, we further found that there are shared pathways in the \
...
drug treatment and prevention of different pathol"}, 
 {"DB" -> "Google Scholar", "TI" -> "Cortical Auditory Evoked Potential \
Indices of Impaired Sensory Gating in People With Chronic Tinnitus", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.lww.com/ear-hearing/fulltext/2024/05000/cortical\
_auditory_evoked_potential_indices_of.18.aspx", 
  "AB" -> "Next   Abstract                                                    \
                                                              Article as EPUB \
    Export All Images to PowerPoint File     Add to My Favorites              \
                                 Email to Colleague                           \
...
Metrics  Abstract"}, {"DB" -> "Google Scholar", 
  "TI" -> "A longitudinal framework to describe the relation between \
age-related hearing loss and social isolation", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.sagepub.com/doi/abs/10.1177/23312165241236041", 
  "AB" -> "Introduction Hearing Loss in Older Adulthood Social Isolation in \
Late Adulthood The Link Between Hearing Loss and Social Isolation \
Psychological and Social Factors That may Influence the Relation Between \
Hearing Loss and Social Isolation Distinguishing Stages Along the Trajectory \
of Changes in Social Behaviors Related to Hearing Loss Implications for \
Research and Future Work Conclusions Declaration of Conflicting Interests \
Funding ORCID iD References PDF/EPUB More          Cite article Share options \
Information, rights and permissions Metrics and citations Figures and tables  \
        Abstract     Many older adults live with some form of hearing loss \
and have difficulty understanding speech in the presence of background sound. \
Experiences resulting from such difficulties include increased listening \
effort and fatigue. Social interactions may become less appealing in the \
context of such experiences, and age-related hearing loss is associated with \
an increased risk of social isolation and associated negative psychosocial \
health outcomes. However, the precise relationship between age-related \
hearing loss and social isolation is not well described. Here, we review the \
literature and synthesize existing work from different domains to propose a \
framework with three conceptual anchor stages to describe the relation \
between hearing loss and social isolation: within-situation disengagement \
from listening, social withdrawal, and social isolation. We describe the \
distinct characteristics of each stage and suggest potential interventions to \
mitigate negative impacts of hearing loss on social lives and health. We \
close by outlining potential implications for researchers and clinicians.     \
Introduction     The World Health Organization's World Report on Hearing \
(2021) indicates that over 65% of adults aged 60 years or above experience \
some form of hearing loss ( Cruickshanks et al., 1998 ; Feder et al., 2015 ; \
Helfer et al., 2017 ), such as speech understanding difficulties when \
background sound is present ( Pang et al., 2019 ; Schneider et al., 2000 ). \
Speech masked by background sound requires a listener to invest cognitively \
to understand what is said ( Hicks & Tharpe, 2002 ; Van Engen et al., 2012 ), \
and this cognitive load appears to be particularly high for older adults with \
hearing loss ( Pichora-Fuller et al., 2016 ; R\[ODoubleDot]nnberg et al., \
2013 ). Common aversive experiences that result from such comprehension \
difficulties and cognitive investment include feelings of listening effort, \
fatigue, and frustration ( Francis & Oliver, 2018 ; Herrmann & Johnsrude, \
2020 ; Hornsby et al., 2016 ; McGarrigle et al., 2014 ; Pichora-Fuller et \
al., 2016 ) that make social interactions less appealing and can lead to \
avoidance behaviors ( Pang et al., 2019 ). It is thus not surprising that \
hearing loss has been associated with fewer social connections and an \
increased likelihood of social isolation ( Bott & Saunders, 2021 ; Shukla et \
al., 2020 ).     Social isolation refer"}, {"DB" -> "Google Scholar", 
  "TI" -> "Complete Restoration of Hearing Loss and Cochlear Synaptopathy via \
Minimally Invasive, Single-Dose, and Controllable Middle Ear Delivery of \
Brain-Derived\[NonBreakingSpace]&#8230;", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> "https://pubs.acs.org/doi/abs/10.1021/acsnano.3c11049", 
  "AB" -> "Click to copy section link Section link copied!               \
...
Hydrogels Microspheres Rodent models Therapeutics"}, 
 {"DB" -> "Google Scholar", "TI" -> "Attitudes towards hearing difficulties, \
health-seeking behaviour, and hearing aid use among older adults in Thailand"\
, "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.frontiersin.org/articles/10.3389/fdgth.2023.1075502/full", 
  "AB" -> "Introduction Material and method Results Discussion Strengths, \
...
findings could guide healthcare providers, resear"}, 
 {"DB" -> "Google Scholar", 
  ...
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.mdpi.com/2076-3425/14/1/95", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
Clinicopathological Challenge Comment Commentary Concept Paper Conference \
Report Correction Creative Data Descriptor Discussion Entry Essay Expression \
of Concern Extended Abstract Field Guide Giants in Urology Guidelines \
...
Advanced Search                                           Section             \
           ...
           Number                 Page                                        \
              Logical Operator Operator   AND OR               Search Text    \
             Search Type   All fields Title Abstract"}, 
 {"DB" -> "Google Scholar", "TI" -> "Exploring functional connectivity \
alterations in sudden sensorineural hearing loss: A multilevel analysis", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0006899323004481", 
  "AB" -> "Sudden sensorineural hearing loss (SSNHL) constitutes an urgent \
otologic emergency, marked by a rapid decline of at least \
30\[NonBreakingSpace]dB across three consecutive frequencies within \
72\[NonBreakingSpace]h. While previous studies have noted brain region \
alterations encompassing both auditory and non-auditory areas, this research \
examines functional connectivity changes across integrity, network, and edge \
levels in SSNHL. The cohort included 184 participants: 107 SSNHL patients and \
77 age- and sex-matched healthy controls. Our investigation comprises: (1) \
characterization of overall functional connectivity degree across 55 nodes in \
nine networks (p\[NonBreakingSpace]<\[NonBreakingSpace]0.05, corrected for \
false discovery rate), exposing integrity level changes; (2) identification \
of reduced intranetwork connectivity strength within sensory and attention \
networks (somatomotor network, auditory network, ventral attention network, \
dorsal attention network) in SSNHL individuals \
...
, {"DB" -> "Google Scholar", 
  "TI" -> "Strategies for Reducing Auditory Risk from a Typical Drum Set", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://digscholarship.unco.edu/capstones/136/", 
  "AB" -> "Percussionists are at risk for noise-induced hearing loss. They \
are especially at risk because of the type of sound produced by their \
instrument \[Dash] impact noise. The quick onset and offset times combined \
with the high peak intensity levels can create permanent damage to the \
auditory system. Damage to the auditory system because of excessive exposure \
to music is called a music-induced hearing disorder (MIHD).       A MIHD may \
manifest as many different permanent disorders including music-induced \
hearing loss, tinnitus, decreased sound tolerance, diplacusis, or dysacusis. \
Symptoms of these disorders may affect the musicians in their art and their \
jobs as many musicians rely on their perception of sound and music to play \
their instruments. Sound exposure can be damaging depending on two factors \
\[Dash] the intensity level that the musician is exposed to and the duration \
of the exposure. Reducing the intensity level of the sound and the duration \
of the exposure can help protect the musician from permanent auditory damage. \
Many products on the market offer a safer listening and playing experience \
for musicians including percussion-specific equipment.       If auditory \
damage has already occurred, the musician should visit an audiologist who can \
provide them with care for their MIHD and education about safe sound exposure \
limits. Best practice guidelines for the audiologist are outlined in Chapter \
II of the document and include thorough education and verified care and \
services. Music-induced hearing disorders are preventable. It is the duty of \
the audiologist to spread awareness and education to percussionists and all \
musicians for the prevention of MIHD.                 Abstract Format       \
html                 Extent       90 pages                 Rights Statement   \
    Copyright is held by the author.                 Recommended Citation     \
   Beatty, Alyssa Marie, \"Strategies for Reducing Auditory Risk from a \
Typical Drum Set\" (2024). Doctoral Capstones & Scholarly Projects . 136.     \
  https://digscholarship.unco.edu/capstones/136                              \
Download                DOWNLOADS       Since May 09, 2024                    \
             Share                         COinS                              \
         About          About UNCOpen       University Libraries       \
Archives & Special Collections        Search      Enter search terms:         \
           Select context to search:           in this series in this \
repository across all repositories                Advanced Search             \
Notify me via email or RSS       Browse       Collections Disciplines Authors \
University Library Exhibits   Contribute          Submit Content    Policies \
& Guidelines    FAQ       Sign In      Links          UNC Graduate School     \
                         Elsevier - Digital Commons             Home | About \
| FAQ | My Account | Accessibility Statement           Privacy   Copyright"}, 
 {"DB" -> "Google Scholar", "TI" -> "Temporary Hearing Threshold Shift in \
California Sea Lions (Zalophus californianus) Due to a Noise Band Centered at \
32 kHz.", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.researchgate.net/profile/John-Terhune-2/publication/3\
78976243_Temporary_Hearing_Threshold_Shift_in_California_Sea_Lions_Zalophus_c\
alifornianus_Due_to_a_Noise_Band_Centered_at_32_kHz/links/65fb0a69d3a08551423\
681af/Temporary-Hearing-Threshold-Shift-in-California-Sea-Lions-Zalophus-cali\
fornianus-Due-to-a-Noise-Band-Centered-at-32-kHz.pdf", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "A Survey on Knowledge, Attitude &amp; Practice of Yakshagana Mela \
Artists Towards Music-Induced Hearing Loss", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://link.springer.com/article/10.1007/s12070-024-04542-w", 
  "AB" -> "Purpose     Yakshagana is a type of folk-art theatre portraying \
...
musical genres and roles [ 5 ]. One among them is"}, 
 {"DB" -> "Google Scholar", "TI" -> "Predictive Model for Prognosis of Sudden \
Sensorineural Hearing Loss by Nomogram", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.sagepub.com/doi/abs/10.1177/01455613241230823", 
  "AB" -> "Introduction Methods Result Discussion Conclusion Ethical Approval \
...
secondary origin, such as viral infection, va"}, 
 {"DB" -> "Google Scholar", "TI" -> "Predicting noise-induced hearing loss \
with machine learning: The influence of tinnitus as a predictive factor", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.cambridge.org/core/journals/journal-of-laryngology-an\
d-otology/article/predicting-noiseinduced-hearing-loss-with-machine-learning-\
the-influence-of-tinnitus-as-a-predictive-factor/2D8580A92728D8E9BA90D840ECB7\
1DF8", "AB" -> "Introduction Methods Result Discussion Conclusion Ethical \
Approval Declaration of Conflicting Interests Funding ORCID iD Data \
availability statement References PDF/EPUB More          Cite article Share \
options Information, rights and permissions Metrics and citations Figures and \
tables          Abstract     Objective: To explore the prognostic factors of \
patients with sudden sensorineural hearing loss (SSNHL), analyze the possible \
influencing factors, and construct a nomogram for personalized evaluation of \
their prognosis. Methods: A retrospective study was conducted on 269 patients \
with SSNHL. The prognostic factors were analyzed by univariate analysis and \
multivariate logistic regression analysis. The nomogram was constructed based \
...
symptoms. SSNHL results from a variety of etiologies of either primary or \
secondary origin, such as viral infection, va"}, 
 {"DB" -> "Google Scholar", "TI" -> "Vestibular function and balance \
performance in children with sensorineural hearing loss", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.tandfonline.com/doi/abs/10.1080/14992027.2023.2281878\
", "AB" -> "Introduction Materials and methods Results Discussion Conclusion \
...
postural sway patterns."}, {"DB" -> "Google Scholar", 
  "TI" -> "ERK1/2 Inhibition via the Oral Administration of Tizaterkib \
Alleviates Noise-Induced Hearing Loss While Tempering down the Immune \
Response", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.mdpi.com/1422-0067/25/12/6305", 
  "AB" -> "Book Review Brief Communication Brief Report Case Report \
Clinicopathological Challenge Comment Commentary Concept Paper Conference \
Report Correction Creative Data Descriptor Discussion Entry Essay Expression \
of Concern Extended Abstract Field Guide Giants in Urology Guidelines \
...
Advanced Search                                           Section             \
 ...
 {"DB" -> "Google Scholar", 
  ...
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://onlinelibrary.wiley.com/doi/abs/10.1111/coa.14113", 
  "AB" -> "Objectives       To assess outcomes associated with \
...
safety of PBMT to treat hearing loss.           1"}, 
 {"DB" -> "Google Scholar", 
  "TI" -> "Hearing Evaluation in Solid Waste Workers", "AU" -> "", 
  "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://esipreprints.org/index.php/esipreprints/article/view/1077\
", "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Map plasticity following noise exposure in auditory cortex of \
rats: implications for disentangling neural correlates of tinnitus and \
hyperacusis", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://www.frontiersin.org/journals/neuroscience/articles/10.338\
9/fnins.2024.1385942/abstract", "AB" -> "1 Introduction 2 Materials and \
methods 3 Results 4 Discussion Data availability statement Ethics statement \
Author contributions Funding Conflict of interest \
...
RESEARCH article     Front. Neurosci. , 31 May 2024      Sec. Auditory \
Cognitive Neuroscience      Volume 18 - 2024 |  \
https://doi.org/10.3389/fnins.2024.1385942       This article is part of the \
Research Topic Bridging the Gap Between the Different Pillars of Tinnitus \
Research View all 5 articles          Map plasticity following noise exposure \
in auditory cortex of rats: implications for disentangling neural correlates \
of tinnitus and hyperacusis                 Naoki Wake  Tomoyo I. Shiramatsu  \
Hirokazu Takahashi *     Department of Mechano-Informatics, Graduate School \
of Information Science and Technology, The University of Tokyo, Tokyo, Japan  \
     Introduction: Both tinnitus and hyperacusis, likely triggered by hearing \
loss, can be attributed to maladaptive plasticity in auditory perception. \
However, owing to their co-occurrence, disentangling their neural mechanisms \
proves difficult. We hypothesized that the neural correlates of tinnitus are \
associated with neural activities triggered by low-intensity tones, while \
hyperacusis is linked to responses to moderate- and high-intensity tones.     \
  Methods: To test these hypotheses, we conducted behavioral and \
electrophysiological experiments in rats 2 to 8\[ThinSpace]days after \
traumatic tone exposure.       Results: In the behavioral experiments, \
prepulse and gap inhibition tended to exhibit different frequency \
characteristics (although not reaching sufficient statistical levels), \
suggesting that exposure to traumatic tones led to acute symptoms of \
hyperacusis and tinnitus at different frequency ranges. When examining the \
auditory cortex at the thalamocortical recipient layer, we observed that \
tinnitus symptoms correlated with a disorganized tonotopic map, typically \
...
activity (MUA) level, but not at the local field potential (LFP) level, in \
response to moderate- and high-intensity tones. This shift from LFP to MUA \
was associated with a loss of monotonicity, suggesting a crucial role for \
inhibitory synapses.       Discussion: Thus, in acute symptoms of traumatic \
tone exposure, our experiments successfully disentangled the neural \
correlates of tinnitus and hyperacusis at the thalamocortical recipient layer \
of the auditory cortex. They also suggested that tinnitus is linked to \
central noise, whereas hyperacusis is associated with aberrant gain control. \
Further interactions between animal experiments and clinical studies"}, 
 {"DB" -> "Google Scholar", "TI" -> "Comprehensive Characterization of \
Hearing Loss and Tinnitus in Military-Affiliated and \
Non&#8211;Military-Affiliated Individuals", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://pubs.asha.org/doi/abs/10.1044/2024_AJA-24-00010", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "&#8220;Every breath you take&#8221;: evaluating sound levels and \
acoustic characteristics of various neonatal respiratory support and \
ventilation modalities", "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", 
  "PT" -> "", "AID" -> 
   "https://www.frontiersin.org/articles/10.3389/fped.2024.1379249/full", 
  "AB" -> "Introduction Materials and methods Results Discussion Limitations \
...
lower soun"}, {"DB" -> "Google Scholar", 
  "TI" -> 
   "Cross-Modal Tinnitus Remediation: A Tentative Theoretical Framework.", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://escholarship.org/uc/item/31f5z79r", 
  "AB" -> "Tinnitus is a prevalent hearing-loss deficit manifested as a \
phantom (internally generated by the brain) sound that is heard as a \
high-frequency tone in the majority of afflicted persons. Chronic tinnitus is \
debilitating, leading to distress, sleep deprivation, anxiety, and even \
suicidal thoughts. It has been theorized that, in the majority of afflicted \
persons, tinnitus can be attributed to the loss of high-frequency input from \
the cochlea to the auditory cortex, known as deafferentation. Deafferentation \
due to hearing loss develops with aging, which progressively causes tonotopic \
regions coding for the lost high-frequency coding to synchronize, leading to \
a phantom high-frequency sound sensation. Approaches to tinnitus remediation \
that demonstrated promise include inhibitory drugs, the use of \
tinnitus-specific frequency notching to increase lateral inhibition to the \
deafferented neurons, and multisensory approaches (auditory-motor and \
audiovisual) that work by coupling multisensory stimulation to the \
deafferented neural populations. The goal of this review is to put forward a \
theoretical framework of a multisensory approach to remedy tinnitus. Our \
theoretical framework posits that due to visions modulatory (inhibitory, \
excitatory) influence on the auditory pathway, a prolonged engagement in \
audiovisual activity, especially during daily discourse, as opposed to \
auditory-only activity/discourse, can progressively reorganize deafferented \
neural populations, resulting in the reduced synchrony of the deafferented \
neurons and a reduction in tinnitus severity over time.     Many UC-authored \
scholarly publications are freely available on this site because of the UC's \
open access policies . Let us know how this access is important for you. Main \
Content     Download PDF to View View Larger     For improved accessibility \
of PDF content, download the file to your device.                             \
                     Thumbnails       Document Outline       Attachments      \
                                                                      \
Previous             Next                 Highlight all     Match case        \
     Whole words                                Presentation Mode       Open  \
     Print       Download       Current View             Go to First Page     \
  Go to Last Page             Rotate Clockwise       Rotate Counterclockwise  \
           Text Selection Tool       Hand Tool             Vertical Scrolling \
      Horizontal Scrolling       Wrapped Scrolling             No Spreads     \
  Odd Spreads       Even Spreads             Document Properties\[Ellipsis]   \
                               Toggle Sidebar             Find             \
Previous             Next                     Presentation Mode       Open    \
   Print       Download       Current View             Tools                  \
   Zoom Out             Zoom In         Automatic Zoom Actual Size Page Fit \
Page Width 50% 75% 100% 125% 150% 200% 300% 400%"}, 
 {"DB" -> "Google Scholar", "TI" -> "Serum Prealbumin as a Potential \
Predictive Factor for Age-Related Hearing Loss: A Retrospective Study", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://journals.sagepub.com/doi/abs/10.1177/01455613241254241", 
  "AB" -> "Introduction Materials and Methods Results Discussion Limitations \
...
7     Tests of liver function can be used as importa"}, 
 {"DB" -> "Google Scholar", "TI" -> "Vocal and musical emotion perception, \
voice cue discrimination, and quality of life in cochlear implant users with \
and without acoustic hearing", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.medrxiv.org/content/10.1101/2024.04.28.24305905.abstract", 
  "AB" -> "Full Text Info/History Metrics Supplementary material Data/Code \
Preview PDF                                                                   \
         Abstract     This study aims to provide a comprehensive picture of \
auditory emotion perception in cochlear implant (CI) users by (1) \
investigating emotion categorization in both vocal (pseudo-speech) and \
musical domains and (2) how individual differences in residual acoustic \
hearing, sensitivity to voice cues (voice pitch, vocal tract length), and \
quality of life (QoL) might be associated with vocal emotion perception and, \
going a step further, also with musical emotion perception. In 28 adult CI \
users, with or without self-reported acoustic hearing, we showed that \
sensitivity (d\[CloseCurlyQuote]) scores for emotion categorization varied \
largely across the participants, in line with previous research. However, \
within participants, the d\[CloseCurlyQuote] scores for vocal and musical \
emotion categorization were significantly correlated, indicating similar \
processing of auditory emotional cues across the pseudo-speech and music \
domains and robustness of the tests. Only for musical emotion perception, \
emotion d\[CloseCurlyQuote] scores were higher in implant users with residual \
...
to anyone (e.g., hospital staff, patients or participants themselves)"}, 
 {"DB" -> "Google Scholar", "TI" -> "Prevalence of hearing loss in", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://pdfs.semanticscholar.org/02f1/62a8955b6aef02036317141265f\
dc7433f2d.pdf", "AB" -> "no abstract available"}, 
 {"DB" -> "Google Scholar", "TI" -> "Hearing loss", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", "AID" -> "https://books.google.de/books\
?hl=de&amp;lr=&amp;id=lG0iEQAAQBAJ&amp;oi=fnd&amp;pg=PP1&amp;dq=(hearing+loss\
+OR+hearing+impairment+OR+hearing+difficulties+OR+acoustic+trauma)+AND+(music\
ian)&amp;ots=Y1FrwCOvDs&amp;sig=THDLNuQqGljXgnTy_2Yrd9yCDQI", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Ear and hearing health in children", "AU" -> "", "DP" -> "", 
  "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S1751722224000210", 
  "AB" -> ""}, {"DB" -> "Google Scholar", 
  "TI" -> 
   "The Effect of Personal Listening Devices on Subjective Hearing Status", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> "https://academicworks.cuny.edu/gc_etds/5714/", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "Sound conditioning strategy promoting paracellular permeability of \
the blood&#8208;labyrinth&#8208;barrier benefits inner ear drug delivery", 
  "AU" -> "", "DP" -> "", "LA" -> "", "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://aiche.onlinelibrary.wiley.com/doi/abs/10.1002/btm2.10596", 
  "AB" -> "no abstract available"}, {"DB" -> "Google Scholar", 
  "TI" -> "The role of hidden hearing loss in tinnitus: insights from early \
markers of peripheral hearing damage", "AU" -> "", "DP" -> "", "LA" -> "", 
  "JT" -> "", "PT" -> "", 
  "AID" -> 
   "https://www.sciencedirect.com/science/article/pii/S0378595524001035", 
  "AB" -> "Since the presence of tinnitus is not always associated with \
